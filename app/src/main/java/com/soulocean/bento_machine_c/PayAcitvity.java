...
import com.soulocean.bento_machine_c.ocean_NotificationO.NotificationCannel;
...
public class PayAcitvity extends AppCompatActivity {
    ...
    private void SendFoodMsg_Notification(String finalMsgstring, String finalFoodname) {
        ...
        NotificationCannel notificationCannel = new NotificationCannel(getApplicationContext());
        notificationCannel.CreateNotificationChannel();
        notificationCannel.sendNotificationMsg("订单完成", "您已下单:" + finalFoodname + ",请到便当机验证取餐");
